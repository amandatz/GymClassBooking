...
public interface IBookingRepository
{
    ...
    Task<IReadOnlyList<BookingResponse>> GetAllProjectedAsync(CancellationToken ct = default);
    Task<IReadOnlyList<Booking>> GetByStudentAndMonthAsync(Guid studentId, int month, int year, CancellationToken ct = default);
